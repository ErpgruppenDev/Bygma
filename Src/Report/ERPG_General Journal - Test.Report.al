...
report 55100 "ERPG_General Journal - Test"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/GeneralJournalTest.rdlc';
    ...
    dataset
    {
        dataitem(GenJournalBatch; "Gen. Journal Batch")
        {
            ...
            dataitem("Integer"; "Integer")
            {
                ...
                column(JnlTemplateName_GenJnlBatch; GenJournalBatch."Journal Template Name")
                {
                }
                column(JnlName_GenJnlBatch; GenJournalBatch.Name)
                {
                }
                ...
                column(JnlTmplNameCaption_GenJnlBatch; GenJournalBatch.FieldCaption("Journal Template Name"))
                {
                }
                ...
                dataitem("Gen. Journal Line"; "Gen. Journal Line")
                {
                    ...
                    column(CurrencyCode_Caption; fieldcaption("Currency Code")) { }
                    column(Payment_Reference; "Payment Reference") { }
                    column(Payment_Reference_Caption; fieldcaption("Payment Reference")) { }
                    column(Amount__LCY_Caption; FieldCaption("Amount (LCY)")) { }
                    ...
                    trigger OnPreDataItem()
                    begin
                        CopyFilter("Journal Batch Name", GenJournalBatch.Name);
