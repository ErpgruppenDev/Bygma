...
report 55101 "PurchaseOrder"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/PurchaseOrderWithoutVATSpec.rdlc';
    Caption = 'Order';
    ...
    dataset
    {
        dataitem("Purchase Header"; "Purchase Header")
        {
            ...
            column(AmountCaption; "Purchase Line".Fieldcaption(Amount)) { }
            ...
            dataitem(CopyLoop; "Integer")
            {
                ...
                dataitem(PageLoop; "Integer")
                {
                    ...
                    column(CompanyInfoBankAccNo; CompanyInfo."Bank Branch No." + '-' + CompanyInfo."Bank Account No.")
                    {
                    }
                    ...
                    column(CompanyInfoBankAccNoCaption; CompanyInfo.FieldCaption("Bank Account No."))  //CompanyInfoBankAccNoCaptionLbl)
                    {
                    }
                    ...
                    column(DocumentDateCaption; "Purchase Header".FieldCaption("Document Date"))
                    {
                    }
                    ...
                    column(CurrencyCodeOut; CurrencyCodeOut) { }
                    ...
                    dataitem(RoundLoop; "Integer")
                    {
                        ...
                        column(DirectUniCostCaption; "Purchase Line".FieldCaption("Direct Unit Cost"))
                        {
                        }
                        column(PurchLineLineDiscCaption; "Purchase Line".FieldCaption("Line Discount %")) //PurchLineLineDiscCaptionLbl)
                        {
                        }
                ...
                begin
                    ...
                    if "Purchase Header"."Currency Code" <> '' then
                        CurrencyCodeOut := "Purchase Header"."Currency Code"
                    else
                        CurrencyCodeOut := GLSetup."LCY Code";
                end;
...
#pragma warning restore AA0074
        ...
        CompanyInfoPhoneNoCaptionLbl: Label 'Phone No.', comment = 'DAN="Telefon"';
        CompanyInfoVATRegNoCaptionLbl: Label 'VAT Registration No.', comment = 'DAN="SE-nummer"';
        CompanyInfoGiroNoCaptionLbl: Label 'Giro No.';
        CompanyInfoBankNameCaptionLbl: Label 'Bank';
        CompanyInfoBankAccNoCaptionLbl: Label 'Account No.', comment = 'DAN="Kontonr."';
        OrderNoCaptionLbl: Label 'Purchase Order No.', comment = 'DAN="Ordrenr.."';
        PageCaptionLbl: Label 'Page', comment = 'DAN="Side"';
        DocumentDateCaptionLbl: Label 'Document Date';
        HdrDimCaptionLbl: Label 'Header Dimensions';
        DirectUniCostCaptionLbl: Label 'Direct Unit Cost';
        PurchLineLineDiscCaptionLbl: Label 'Discount %', comment = 'DAN="Rabat %"';
        VATDiscountAmountCaptionLbl: Label 'Payment Discount on VAT';
        LineDimCaptionLbl: Label 'Line Dimensions';
        PaymentDetailsCaptionLbl: Label 'Payment Details';
        VendNoCaptionLbl: Label 'Vendor No.';
        ShiptoAddressCaptionLbl: Label 'Ship-to Address', comment = 'DAN="Leveringsadresse"';
        ...
        AmountCaptionLbl: Label 'Amount', comment = 'DAN="Beløb"';
        PurchLineInvDiscAmtCaptionLbl: Label 'Invoice Discount Amount';
        SubtotalCaptionLbl: Label 'Subtotal';
        VATAmtLineVATCaptionLbl: Label 'VAT %', comment = 'DAN="Moms %"';
        VATAmtLineVATAmtCaptionLbl: Label 'VAT Amount', comment = 'DAN="Momsbeløb"';
        VATAmtSpecCaptionLbl: Label 'VAT Amount Specification', comment = 'DAN="Momsbeløb specifikation"';
        VATIdentifierCaptionLbl: Label 'VAT Identifier';
        VATAmtLineInvDiscBaseAmtCaptionLbl: Label 'Invoice Discount Base Amount';
        VATAmtLineLineAmtCaptionLbl: Label 'Line Amount', comment = 'DAN="Linjebeløb"';
        VALVATBaseLCYCaptionLbl: Label 'VAT Base', comment = 'DAN="Momsgrundlag"';
        TotalCaptionLbl: Label 'Total';
        PaymentTermsDescCaptionLbl: Label 'Payment Terms', comment = 'DAN="Betalingsbetingelser"';
        ShipmentMethodDescCaptionLbl: Label 'Shipment Method', comment = 'DAN="Leveringsform';
        PrepymtTermsDescCaptionLbl: Label 'Prepmt. Payment Terms';
        HomePageCaptionLbl: Label 'Home Page', comment = 'DAN="Hjemmeside"';
